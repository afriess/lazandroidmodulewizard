...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     rc := RegisterNativeMethods(curEnv, 'org/lamw/appbarcodegendemo1/Controls'
       );
...
exports
  ...
  pOnDone name 'Java_org_lamw_appbarcodegendemo1_Controls_pOnDone',
  pOnSearch name 'Java_org_lamw_appbarcodegendemo1_Controls_pOnSearch',
  pOnNext name 'Java_org_lamw_appbarcodegendemo1_Controls_pOnNext',
  pOnGo name 'Java_org_lamw_appbarcodegendemo1_Controls_pOnGo',
  ...
  pOnFocus name 'Java_org_lamw_appbarcodegendemo1_Controls_pOnFocus',
  ...
  pOnRunOnUiThread name 'Java_org_lamw_appbarcodegendemo1_Controls_'
    +'pOnRunOnUiThread',
