...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 29.03.2024 10:51:57]
...
{ Class:     org_dldemo_appdatalogicdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_dldemo_appdatalogicdemo1_Controls
  Method:    pOnBarcodeRead
  Signature: (JLjava/lang/String;Ljava/lang/String;)V }
procedure pOnBarcodeRead(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  symbol: JString; bc: JString); cdecl;
begin
  Java_Event_pOnBarcodeRead(PEnv, this, TObject(pasobj), symbol, bc);
end;
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     rc := RegisterNativeMethods(curEnv, 'org/dldemo/appdatalogicdemo1/Controls'
       );
...
exports
  ...
  pAppOnCreate name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_dldemo_appdatalogicdemo1_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_dldemo_appdatalogicdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnDown',
  pOnUp name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnUp',
  pOnClick name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnBackPressed',
  pOnDone name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnDone',
  pOnSearch name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnSearch',
  pOnNext name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnNext',
  pOnGo name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnGo',
  pOnClose name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_dldemo_appdatalogicdemo1_Controls'
    +'_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_dldemo_appdatalogicdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_dldemo_appdatalogicdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnRunOnUiThread',
  pOnBarcodeRead name 'Java_org_dldemo_appdatalogicdemo1_Controls_'
    +'pOnBarcodeRead',
  pEditTextOnActionIconTouchUp name 'Java_org_dldemo_appdatalogicdemo1_'
    +'Controls_pEditTextOnActionIconTouchUp',
  pEditTextOnActionIconTouchDown name 'Java_org_dldemo_appdatalogicdemo1_'
...
begin
  ...
  gjAppName:= 'org.dldemo.appdatalogicdemo1';
  gjClassName:= 'org/dldemo/appdatalogicdemo1/Controls';
